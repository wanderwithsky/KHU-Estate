...
export default function SeniorTLLayout() {
    ...
    <div className="flex h-screen bg-brand-warm-white">
      ...
      <aside className="w-64 bg-brand-charcoal text-white flex flex-col">
        <div className="p-6 border-b border-white/10">
          ...
          <p className="text-xs text-white/50 uppercase tracking-widest mt-1">Senior TL Portal</p>
        </div>
        <nav className="flex-1 p-4 space-y-2">
          <Link to="/senior-team-leader" className="block px-4 py-2 rounded hover:bg-white/10 text-sm font-medium transition-colors">Overview</Link>
          <Link to="/senior-team-leader/team" className="block px-4 py-2 rounded hover:bg-white/10 text-sm font-medium transition-colors">Team Leaders</Link>
        </nav>
