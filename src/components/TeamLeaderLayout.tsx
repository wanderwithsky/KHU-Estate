    ...
    <div className="flex h-screen bg-brand-warm-white">
      ...
      <aside className="w-64 bg-brand-charcoal text-white flex flex-col">
        <div className="p-6 border-b border-white/10">
          ...
          <p className="text-xs text-white/50 uppercase tracking-widest mt-1">Team Leader Portal</p>
        </div>
        <nav className="flex-1 p-4 space-y-2">
          <Link to="/team-leader" className="block px-4 py-2 rounded hover:bg-white/10 text-sm font-medium transition-colors">Applications</Link>
        </nav>
      ...
      <main className="flex-1 overflow-auto flex flex-col">
        <header className="bg-white border-b border-brand-soft-grey p-6 flex justify-between items-center shadow-sm">
          <h1 className="text-xl font-serif text-brand-deep-navy">Team Leader Dashboard</h1>
        </header>
